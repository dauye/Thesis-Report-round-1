...
\section{Introduction}
	...
	\subsection{Office Building Introduction}
		...
		\begin{figure}[h!]
		\centering
		\includegraphics[scale=0.2]{Sumatra_photo.jpg}
...
\section{Literature Review}
	...
	\subsection{SIA Documentations}
		...
		\textbf{SIA 380/1: Thermal energy in buildings}\\
			...
			\begin{figure}[!h]
			\centering
			\includegraphics[scale=0.8]{Figure/SIA380Issue.jpg}
	...
	\subsection{Previous Research}
		 One simular research has been done in 2015 aiming to investigate the reason behind the huge performance gap in uninsulated old buildings when using SIA 380/1 and SIA 382 calculation method. The research concluded that three main reasons are the most important: too poor U-values, too low indoor air temperature for unheated ares, and discrepancies between standard climate data and actual outdoor air temperature \cite{SIAPreviousreport}.
...
\section{Methodology}
	...
	\subsection{Building Model Construction}
		...
		Figure \ref{fig:SumatraDB} and \ref{fig:HonggDB} below shows a complete office building geometry.\\
		...
		\subsection{Weather Data Selection}
			...
			\textbf{2015 Weather Data}\\
				...
				\caption{Weather Data Comparison}
				    \begin{tabular}{|c|c|c|}
				    \toprule
				         & \multicolumn{1}{c}{SIA Standard Weather} & 2015 Weather \\
				    \midrule
				    Heating Day & 208  & 175 \\
				    \midrule
				    Heating Degree Day & 3260 & 2513 \\
				    \midrule
				    Annual Average Temperature & 8.5  & 12.3 \\
				    \bottomrule
				    \end{tabular}%
			...
			\subsubsection{Weather Data For Dynamic Calculation}
				An .\textit{epw} weather file is needed for dynamic calculation using \textit{EnergyPlus}. The weather file is either from a meteological organization or from modifing an existing weather file.\\

			\textbf{Typical Year Weather File}\\
				A typical year Zurich weather file is given by EMPA research unit. It also become the basis for other custom-made weather files that are used in this thesis.\\
	...
	\subsection{Static Calculation}
		...
		\subsubsection{Heat Gains}
			...
			\[\dot{Q}_{\text{elec}} = f_{ele} \cdot HT \cdot E_{unit} \cdot A_{floor} \cdot 3.6\]
			...
			\[Q_{\text{occ}} = \text{Occ} \cdot \dot{q_{pl}} \cdot h_{\text{present}} \cdot 3.6\]
			where:\\
			...
			$\dot{q}_{pl} = 70W$: internal gain produce by a single person\\
	...
	\subsection{Dynamic Analysis}
		...
		\subsubsection{Schedule and Occupancy Assumptions}
			...
			The detailed information of is stored in separate .\textit{csv} files which contains 8760 entries of hourly data.
			...
			\caption{Heating Temperature Setpoint}
			\label{fig:HeatingSP}
			\end{figure}
...
\section{Results}
	...
	\subsection{Initial Annual Energy Analysis}
		...
		\textbf{Residential Building}
		


		\textbf{Thermal Bridge}
		...
		\caption{Thermal Bridge Calculation For Residential Building}
		    ...
		    \midrule
		    \multicolumn{2}{c}{Total} &      & 191.8 &      &      & 14.0469475 & 10.82885211 \\
		    \bottomrule
		    \end{tabular}%
